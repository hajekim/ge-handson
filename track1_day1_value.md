...
<div style="text-align: center; margin: 1.2rem 0;"><a href="slide_track1.html" target="_blank" style="display: inline-flex; align-items: center; gap: 8px; background: linear-gradient(135deg, #1a73e8, #1558b0); color: #fff; font-weight: 700; font-size: 14px; padding: 10px 22px; border-radius: 25px; text-decoration: none; box-shadow: 0 4px 12px rgba(26, 115, 232, 0.3);">📽️ Track 1 슬라이드 모드로 강의 시작 ↗</a></div>
