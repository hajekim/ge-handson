...
> 아래는 `1.7 프롬프트 작성법`에서 다루는 **CRAFT** 구조(Role → Context → Action → Format)를 Excel 분석에 바로 적용한 예시입니다. 대괄호 `[...]` 안의 내용을 본인의 실제 데이터에 맞게 교체하여 활용하세요.
> ```markdown
...
> ```
> 📖 CRAFT/APE/CO-STAR 프레임워크 심화 학습은 **[1.7 프롬프트 작성법](#17-프롬프트-작성법)** 을 참고하세요.
