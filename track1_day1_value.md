...
- **시나리오 B: 손그림 스케치를 클라우드 정밀 아키텍처 다이어그램으로 변환 (Image-to-Image)**:
  손그림을 올리면 전문적인 기업용 아키텍처 다이어그램으로 바꿔줍니다.
...
프롬프트를 잘 쓰면 결과물의 품질이 달라집니다. 실무에서 자주 쓰이는 **C.R.A.F.T** 구조를 중심으로, 원하는 답변을 정확히 끌어내는 법을 다뤄봅니다.
...
보고서, 이메일, 기획안 등 어디서든 바로 쓸 수 있는 <b>'범용 비즈니스 표준 템플릿'</b>과 항목별 작성 포인트입니다.
...
위 템플릿을 실제 업무 상황에 맞게 풀어쓴 <b>4가지 현업 실전 프롬프트</b>입니다.
