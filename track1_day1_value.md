...
### 3) 📝 실전 비즈니스 적용 템플릿 라이브러리

구글 제미나이 엔터프라이즈 교육 교안에 정의된 실제 임직원 및 각 직무 전문가들의 최고 수준 C.R.A.F.T 구조화 템플릿 실물 세트입니다.

> [!IMPORTANT]
> **범용 비즈니스 작성 표준 템플릿 & 4대 실무 시나리오 분리 안내**
> - 모든 부서에서 통용되는 **범용 표준 템플릿**의 해부학적 세부 분석(Anatomy) 및 이를 실제 비즈니스 상황(신규 제안서 기획, 고객 클레임 해결, 보도자료 SWOT 분석, IT 장애 보고서)으로 확장 적용한 실물 예시는 독자적인 마스터 가이드 파일로 이관되었습니다.
> - **지금 바로 학습하기**: [👉 C.R.A.F.T 프롬프트 마스터 가이드 (표준 템플릿 & 4대 시나리오)](./prompt_guide.md)

---

### 🗃️ 직무별 특화 프롬프트 템플릿 (9종)
