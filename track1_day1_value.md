...
- **실습 파일**: [coffee orders.xlsx](./samples/coffee%20orders.xlsx) (위 링크를 클릭해 컴퓨터에 다운로드한 후, 대화 창에 업로드하여 사용합니다.)
...
- **실습 파일**: [202603-BigQuery New Feature Update.pptx](./samples/202603-BigQuery%20New%20Feature%20Update.pptx) (위 링크를 클릭해 컴퓨터에 다운로드한 후, 대화 창에 업로드하여 사용합니다.)
