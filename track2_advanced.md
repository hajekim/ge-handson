...
이 트랙은 구글 드라이브, 사내 데이터 스토어 등 **원천 데이터 소스와의 실시간 RAG 검색(Retrieval-Augmented Generation) 연동 및 임직원 맞춤형 노코드/하이코드 에이전트 기획 및 개발 실습**을 다룹니다.
...
## 2.4. 자율형 심층 조사(Deep Research) 및 아이디어 연쇄 생성
