...
<div class="download-card">
  <div class="download-card-left">
    ...
    <div class="download-text">
      ...
      <p>RAG 실습용 내규·가이드라인 PDF 2종, 시네마틱 슬라이드 실습용 이미지 패키지 1종, Canvas 동영상 실습용 파일 2종 — 총 5종을 미리 다운로드합니다.</p>
    </div>
  </div>
...
<div class="verify-card" data-verify-id="track2-data">
  ...
  <span>Track 2 전체 실습에 활용할 샘플 파일 5종(내규·가이드라인 PDF 2종, homestyle.zip, canvas.pdf, canvas.zip)을 내 컴퓨터에 다운로드하였습니다.</span>
</div>
...
새로운 노트북을 하나 생성합니다. Drive 소스의 **공유 문서함**에서 **BQ Data Agent** 폴더의 `data_agent.zip`을 다운로드해 로컬에서 압축 해제한 뒤, 파일 업로드로 이미지 10개를 소스에 추가합니다. NotebookLM 우측 **Studio** 패널에서 클릭 한 번으로 3종의 설명서를 자동 생성합니다.
...
1. [NotebookLM 홈](https://notebooklm.google/)에서 **새로만들기**를 클릭합니다. **소스 추가** → **Drive**를 선택한 뒤 **공유 문서함 > BQ Data Agent** 폴더에서 `data_agent.zip`을 다운로드합니다. 로컬에서 압축을 해제한 뒤, **파일 업로드**로 이미지 10개를 소스에 추가합니다.
