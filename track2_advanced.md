...
내가 올린 문서 안에서만 답하는 신뢰할 수 있는 팀 지식 도서관입니다. 아래 6가지 실습을 순서대로 진행합니다.

| 실습 | 내용 |
|------|------|
| **실습 1** | RFP·제안서 GAP 분석 |
| **실습 2** | 신사업 기획 텍스트 → 슬라이드 자료 자동 생성 |
| **실습 3** | AI 인포그래픽 3종 스타일 변환 + Audio Overview |
| **실습 4** | 제품 이미지 소스 → 🎬 시네마틱 슬라이드 생성 |
| **실습 5** | 📖 설명서 만들기 (스터디 가이드 · FAQ · 브리핑 문서) |
| **실습 6** | 🎬 동영상 만들기 (Canvas 기능 튜토리얼 영상 자동 생성) |
...
1. **NotebookLM 접속 및 노트북 생성**: [NotebookLM 홈](https://notebooklm.google/)에서 **새로만들기**를 클릭합니다.

   <img src="./img/39.png" width="600" alt="NotebookLM 메뉴 진입">
   <img src="./img/40.png" width="600" alt="새 노트북 만들기">
2. **소스 업로드**: 다운로드한 RFP와 제안서 초안 PDF 2종을 한꺼번에 소스로 바인딩합니다.
...
### 🖥️ 실습 2: 신사업 기획 텍스트 → 슬라이드 자료 자동 생성

NotebookLM은 업로드된 소스를 바탕으로 **발표용 슬라이드 덱을 한 번의 클릭**으로 만들어냅니다. 아래 3가지 신사업 아이디어 초안을 소스로 추가하고, 슬라이드 자료 자동 생성을 체험합니다.
...
4. **슬라이드 자료 생성**: 노트북 왼쪽 상단의 **슬라이드 자료** 버튼을 클릭합니다. 잠시 후 3가지 사업 아이디어를 포괄하는 발표용 슬라이드 덱이 자동 완성됩니다.

   <img src="./img/43.png" width="600" alt="슬라이드 자료 생성 버튼">
   <img src="./img/44.png" width="600" alt="신사업 기획 슬라이드 자료 생성 결과">

---

### 🎨 실습 3: AI 인포그래픽 생성 (스타일 변환 실습)

**같은 노트북**에서 계속 진행합니다. 소스로 등록된 3가지 신사업 기획안을 기반으로 **인포그래픽 3종**을 각각 다른 스타일로 만들어봅니다.
...
실습 1에서 만든 **RFP·제안서 노트북**을 그대로 사용합니다. NotebookLM 우측 **Studio** 패널에서 클릭 한 번으로 3종의 설명서를 자동 생성합니다.
...
1. 실습 1 노트북을 엽니다 (RFP + 제안서 초안 소스 2종이 로드된 상태).
...
강사가 제공하는 실습 자료 패키지에서 아래 2개 파일을 내려받습니다.
